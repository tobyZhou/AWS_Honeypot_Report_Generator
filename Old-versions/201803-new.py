...
def get_ip_country_city(ip):
    ...
    try:
        ...
        if response.country.name:
            ...
            if country in Country_Name_Replacement:
                country = Country_Name_Replacement[country]
        else:
            country = "None"
...
def generate_html_files(date, honeypots):
    print "Generating htmls"
    generate_html_tcp_file(date, honeypots)
...
def generate_csv_files(date, honeypots):
    print "Generating CSVs"
    generate_csv_tcp_file(date, honeypots)
...
def generate_csv_tcp_file(date, honeypots):
