...
class BasicPacket:
    def __init__(self, src_ip="", dst_ip="", packet_size=0, country="", city=""):
        self.src_ip = src_ip
        self.dst_ip = dst_ip
...
class TcpPacket(BasicPacket):
    def __init__(self, src_ip="", src_port=-1, dst_ip="", dst_port=-1, packet_size=0, country="", city=""):
        BasicPacket.__init__(self, src_ip, dst_ip, packet_size, country, city)
...
class IcmpPacket(BasicPacket):
    def __init__(self, src_ip="", dst_ip="", packet_size=0, country="", city="", icmp_type=-1):
        BasicPacket.__init__(self, src_ip, dst_ip, packet_size, country, city)
                        ...
                        if isinstance(_pl2, TCP) and hasattr(_pl2, "dport"):
                            ...
                            if icmp_type in ICMP_Checking_Types:
                                ...
                                icmp_packet = IcmpPacket(src_ip=_pl1.src, dst_ip=_pl1.dst, packet_size=block.packet_len,
                                    country=country, city=city, icmp_type=_pl2.type)
